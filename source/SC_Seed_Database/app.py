...
DB_URL = os.getenv('VEHICLE_METADATA_DB_URL', 'https://github.com/red-hat-data-services/smart-city-with-rh-cloud-services/raw/main/source/SC_Seed_Database/vehicle_metadata_db.json')
