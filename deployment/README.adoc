...
1. This should bring you to the right screen, but if it doesn't, go to *Streams for Apache Kafka* > *Kafka Instances* and click *Create Kafka Instance* 
2. Enter the name as `sc-kafka`, select a region, and click *Create instance*. 
3. Wait a few minutes until *Status* is *Ready*.
...
0. Return to the *Kafka Instances* (on the left, *Streams for Apache Kafka* > *Kafka Instances*) view and select the vertical dots on the right side of your kafka instance listing. Select *Connection*.
